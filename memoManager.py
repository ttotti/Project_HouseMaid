...
class memoManager:
    ...
    def UI(self):
        ...
        # 어차피 트리위젯에서 
        folder_treeview = QTreeWidget()
        folder_treeview.setHeaderLabel("폴더")

        file_treeview = QTreeWidget()
        file_treeview.setHeaderLabels(["제목", "생성일", "수정일", "그룹"])

        textEdit = QTextEdit()
        textEdit.setAcceptRichText(False)


        self.addFolder(folder_treeview, "폴더1")
        self.addFile(file_treeview, "파일1", "2021-08-01", "2021-08-01", "폴더1")
